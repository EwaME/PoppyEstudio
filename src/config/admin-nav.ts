...
import { LayoutDashboard, Tags, Package, Images, Newspaper, Users, ShieldCheck, History } from 'lucide-react';
...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { label: 'Blog', href: '/admin/blog', icon: Newspaper, permission: 'blog.view' },
